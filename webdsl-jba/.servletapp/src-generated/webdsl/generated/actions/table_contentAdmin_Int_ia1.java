...
public class table_contentAdmin_Int_ia1 extends TemplateAction 
{ 
    ...
    handleAction(threadLocalPageCached, env, elementsContext, actionident, new TemplateActionBody()
                                                                           { 
                                                                             ...
                                                                             { 
                                                                               ...
                                                                               { 
                                                                                 ThreadLocalPage.get().setRedirectUrl(utils.Navigate.constructUrl("page_admin_edit", utils.CollectionType.addAll(new java.util.ArrayList<String>(2), utils.URLFilter.filter(admin__.getNaturalId()), utils.URLFilter.filter(u__.getCount())), "Admin", "Int"));
                                                                               }
                                                                               else
                                                                               { 
