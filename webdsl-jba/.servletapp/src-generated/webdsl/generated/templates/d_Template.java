...
public @SuppressWarnings("all") class d_Template extends TemplateServlet 
{ 
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "d" : keyOverwrite, d_Template.class);
  ...
  { 
    ...
    { 
      ...
      handleTemplateCall(phase, inForLoop, forelementcounter, "tcall51", elems.name, env.addExtraLocalTemplateArgumentsToArguments(elems.args, elems.name), new Environment(env), elems.parentName, attrsmapout);
    }
