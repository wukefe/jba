...
@SuppressWarnings("all") public class RefArg_page_admin_index_Template3  implements utils.RefArg
{ 
  public page_admin_index_Template template;

  public RefArg_page_admin_index_Template3 (page_admin_index_Template templ) 
  { 
    this.template = templ;
  }
  ...
  { 
    template.setUtitle_((String)org.webdsl.tools.Utils.cast(obj, String.class));
    return this;
  }

  public Object get()
  { 
    return template.getUtitle_();
  }
