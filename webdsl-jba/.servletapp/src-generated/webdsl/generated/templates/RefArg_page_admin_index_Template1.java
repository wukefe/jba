...
@SuppressWarnings("all") public class RefArg_page_admin_index_Template1  implements utils.RefArg
{ 
  public page_admin_index_Template template;

  public RefArg_page_admin_index_Template1 (page_admin_index_Template templ) 
  { 
    this.template = templ;
  }
  ...
  { 
    template.setId_((Integer)org.webdsl.tools.Utils.cast(obj, Integer.class));
    return this;
  }

  public Object get()
  { 
    return template.getId_();
  }
