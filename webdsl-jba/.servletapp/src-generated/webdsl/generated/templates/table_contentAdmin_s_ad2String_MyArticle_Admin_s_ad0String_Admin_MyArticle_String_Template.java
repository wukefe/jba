...
public @SuppressWarnings("all") class table_contentAdmin_s_ad2String_MyArticle_Admin_s_ad0String_Admin_MyArticle_String_Template extends TemplateServlet 
{ 
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "table_contentAdmin_s_ad2String_MyArticle_Admin_s_ad0String_Admin_MyArticle_String" : keyOverwrite, table_contentAdmin_s_ad2String_MyArticle_Admin_s_ad0String_Admin_MyArticle_String_Template.class);
  ...
  { 
    table_contentAdmin_ia24_ = (String)args[0];
    admin_ = (webdsl.generated.domain.Admin)args[1];
    u_ = (webdsl.generated.domain.MyArticle)args[2];
    table_contentAdmin_ia20_ = (String)args[3];
  }

  public String getUniqueName()
  { 
    return "table_contentAdmin_s_ad2String_MyArticle_Admin_s_ad0String_Admin_MyArticle_String";
  }
  ...
  { 
    return "template table_contentAdmin_s_ad2String_MyArticle_Admin_s_ad0(table_contentAdmin_ia24 : String, admin : Admin, u : MyArticle, table_contentAdmin_ia20 : String)";
  }
  ...
  private String table_contentAdmin_ia24_ = "";

  public void setTable_contentAdmin_ia24_(String table_contentAdmin_ia24_)
  { 
    this.table_contentAdmin_ia24_ = table_contentAdmin_ia24_;
  }

  public String getTable_contentAdmin_ia24_()
  { 
    return table_contentAdmin_ia24_;
  }
  ...
  { 
    ...
    { 
      case DATABIND_PHASE:
        ident = table_contentAdmin_ia24_;
        if(threadLocalPageCached.getParammap().get(ident) != null)
        { 
          threadLocalPageCached.actionToBeExecutedHasDisabledValidation = table_contentAdmin_ia2.isValidationDisabled();
        }
        break;
      ...
      case ACTION_PHASE:
        ...
        { 
          ...
          new table_contentAdmin_ia2().run(threadLocalPageCached, getEnv(), getElementsContext(), u_, admin_, admin_, ident);
        }
        break;
      ...
      case RENDER_PHASE:
        if(isAjaxSubmitRequired(false))
        { 
          out.print("<button onclick='javascript:serverInvoke(\"" + threadLocalPageCached.getAbsoluteLocation() + "/" + threadLocalPageCached.getActionTarget() + threadLocalPageCached.getExtraQueryAruments("?") + "\",\"" + table_contentAdmin_ia24_ + "\", [" + threadLocalPageCached.getHiddenPostParamsJson() + "],\"" + threadLocalPageCached.getFormIdent() + "\", this, true); return false;'");
          { 
        ...
        { 
          out.print("<button name=\"" + table_contentAdmin_ia24_ + "\"");
          { 
            StringBuilder classattrs = new StringBuilder();
            StringBuilder styleattrs = new StringBuilder();
            java.util.List<String> ignore = new java.util.ArrayList<String>();
