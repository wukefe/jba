...
public @SuppressWarnings("all") class page_admin_indexAdmin_s_ad1String_WikiText_Text_MyArticle_Admin_Template extends TemplateServlet 
{ 
  ...
  { 
    ...
    { 
      if(i == 5)
      { 
        java.util.ArrayList<webdsl.generated.domain.Admin> elems25 = new java.util.ArrayList<webdsl.generated.domain.Admin>();
        for(org.webdsl.WebDSLEntity ent : elems)
        { 
          if(ent.instanceOf("Admin"))
          { 
            elems25.add((webdsl.generated.domain.Admin)ent);
          }
        }
      }
    }
  ...
  { 
    page_admin_indexAdmin_s_ad1String_WikiText_Text_MyArticle_Admin_s_ad0String_Admin_MyArticle_Text_WikiText_String_Template.loadTemplateMap(staticEnv);
  }

  public static void loadRefArgClasses(Map<String, Class<?>> refargclasses)
  { 
    page_admin_indexAdmin_s_ad1String_WikiText_Text_MyArticle_Admin_s_ad0String_Admin_MyArticle_Text_WikiText_String_Template.loadRefArgClasses(refargclasses);
  }
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "page_admin_indexAdmin_s_ad1String_WikiText_Text_MyArticle_Admin" : keyOverwrite, page_admin_indexAdmin_s_ad1String_WikiText_Text_MyArticle_Admin_Template.class);
  ...
  { 
    return "page_admin_indexAdmin_s_ad1String_WikiText_Text_MyArticle_Admin";
  }
  ...
  { 
    return "template page_admin_indexAdmin_s_ad1(page_admin_indexAdmin_clearContent10 : String, y : Ref<WikiText>, x : Ref<Text>, u : Ref<MyArticle>, admin : Admin)";
  }
