...
public @SuppressWarnings("all") class table_contentAdmin_Int_s_ad0String_MyArticle_Int_Admin_Template extends TemplateServlet 
{ 
  ...
  { 
    table_contentAdmin_Int_s_ad0String_MyArticle_Int_Admin_s_ad0String_Admin_Int_MyArticle_String_Template.loadTemplateMap(staticEnv);
  }

  public static void loadRefArgClasses(Map<String, Class<?>> refargclasses)
  { 
    table_contentAdmin_Int_s_ad0String_MyArticle_Int_Admin_s_ad0String_Admin_Int_MyArticle_String_Template.loadRefArgClasses(refargclasses);
  }
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "table_contentAdmin_Int_s_ad0String_MyArticle_Int_Admin" : keyOverwrite, table_contentAdmin_Int_s_ad0String_MyArticle_Int_Admin_Template.class);
  ...
  { 
    table_contentAdmin_Int_ia00_ = (String)args[0];
  ...
  { 
    return "table_contentAdmin_Int_s_ad0String_MyArticle_Int_Admin";
  }
  ...
  { 
    return "template table_contentAdmin_Int_s_ad0(table_contentAdmin_Int_ia00 : String, u : MyArticle, len : Int, admin : Admin)";
  }
  ...
  { 
    ...
    { 
      ...
      { 
        try
        { 
          handleTemplateCall(phase, inForLoop, forelementcounter, "tcall12", "wrapsubmitString", env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"table_contentAdmin_Int_ia0_" + webdsl.generated.functions.getPage_.getPage_().getTemplateContext().getTemplateContextString()}, "wrapsubmitString"), new Environment(env).putWithcall("s", new utils.TemplateCall("table_contentAdmin_Int_s_ad0String_MyArticle_Int_Admin_s_ad0String_Admin_Int_MyArticle_String", getElementsContext(), new Object[]{admin_, len_, u_, table_contentAdmin_Int_ia00_}, attrs)), "wrapsubmitString", TemplateCall.EmptyAttrs);
        }
