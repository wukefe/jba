...
public @SuppressWarnings("all") class page_admin_indexAdmin_Int_s_ad0String_MyArticle_Int_WikiText_WikiText_Text_MyArticle_Int_Admin_Template extends TemplateServlet 
{ 
  ...
  { 
    page_admin_indexAdmin_Int_s_ad0String_MyArticle_Int_WikiText_WikiText_Text_MyArticle_Int_A34String_Admin_Int_MyArticle_Text_WikiText_WikiText_Int_MyArticle_String_Template.loadTemplateMap(staticEnv);
  }

  public static void loadRefArgClasses(Map<String, Class<?>> refargclasses)
  { 
    page_admin_indexAdmin_Int_s_ad0String_MyArticle_Int_WikiText_WikiText_Text_MyArticle_Int_A34String_Admin_Int_MyArticle_Text_WikiText_WikiText_Int_MyArticle_String_Template.loadRefArgClasses(refargclasses);
  }
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "page_admin_indexAdmin_Int_s_ad0String_MyArticle_Int_WikiText_WikiText_Text_MyArticle_Int_Admin" : keyOverwrite, page_admin_indexAdmin_Int_s_ad0String_MyArticle_Int_WikiText_WikiText_Text_MyArticle_Int_Admin_Template.class);
  ...
  { 
    return "page_admin_indexAdmin_Int_s_ad0String_MyArticle_Int_WikiText_WikiText_Text_MyArticle_Int_Admin";
  }
  ...
  { 
    return "template page_admin_indexAdmin_Int_s_ad0(page_admin_indexAdmin_Int_saveContent10 : String, art : Ref<MyArticle>, id : Ref<Int>, ucontent : Ref<WikiText>, utitle : Ref<WikiText>, x : Ref<Text>, u : Ref<MyArticle>, indx : Int, admin : Admin)";
  }
