...
public @SuppressWarnings("all") class login_ta0Bool_String_String_Template extends TemplateServlet 
{ 
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "login_ta0Bool_String_String" : keyOverwrite, login_ta0Bool_String_String_Template.class);
  ...
  { 
    return "login_ta0Bool_String_String";
  }
  ...
  { 
    return "template login_ta0(stayLoggedIn : Ref<Bool>, credPassword : Ref<String>, credUsername : Ref<String>)";
  }
  ...
  { 
    ...
    try
    { 
      handleTemplateCall(phase, inForLoop, forelementcounter, "tcall6", "inputString", env.addExtraLocalTemplateArgumentsToArguments(new Object[]{credUsername_}, "inputString"), new Environment(env).putWithcall("elements#inputString", new utils.TemplateCall("elementsempty", null, null, null)), "inputString", TemplateCall.EmptyAttrs);
    }
    catch(RuntimeException ex)
    { 
      printTemplateCallException(ex, "inputString(credUsername) at unknown context");
    }
  }
}