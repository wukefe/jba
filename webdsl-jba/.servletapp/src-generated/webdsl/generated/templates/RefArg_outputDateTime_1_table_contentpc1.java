...
@SuppressWarnings("all") public class RefArg_outputDateTime_1_table_contentpc1  implements utils.RefArg
{ 
  public webdsl.generated.domain.MyArticle u_;

  public RefArg_outputDateTime_1_table_contentpc1 () 
  { }

  public RefArg_outputDateTime_1_table_contentpc1 (Object u_) 
  { 
  ...
  { 
    u_.setModified((java.util.Date)org.webdsl.tools.Utils.cast(obj, java.util.Date.class));
    return u_;
  }

  public Object get()
  { 
    return (java.util.Date)u_.getModified();
  }
  ...
  { 
    return u_.getId() + "!" + "RefArg_outputDateTime_1_table_contentpc1";
  }
  ...
  { 
    return utils.ThreadLocalServlet.get().getReflectionEntityByName("MyArticle").getPropertyByName("modified");
  }
