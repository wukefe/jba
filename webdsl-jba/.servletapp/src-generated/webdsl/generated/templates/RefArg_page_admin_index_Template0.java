...
@SuppressWarnings("all") public class RefArg_page_admin_index_Template0  implements utils.RefArg
{ 
  public page_admin_index_Template template;

  public RefArg_page_admin_index_Template0 (page_admin_index_Template templ) 
  { 
    this.template = templ;
  }
  ...
  { 
    template.setArt_((webdsl.generated.domain.MyArticle)org.webdsl.tools.Utils.cast(obj, webdsl.generated.domain.MyArticle.class));
    return this;
  }

  public Object get()
  { 
    return template.getArt_();
  }
