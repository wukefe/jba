...
public @SuppressWarnings("all") class page_admin_indexAdmin_s_ad0String_WikiText_Text_MyArticle_Admin_s_ad0String_Admin_MyArticle_Text_WikiText_String_Template extends TemplateServlet 
{ 
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "page_admin_indexAdmin_s_ad0String_WikiText_Text_MyArticle_Admin_s_ad0String_Admin_MyArticle_Text_WikiText_String" : keyOverwrite, page_admin_indexAdmin_s_ad0String_WikiText_Text_MyArticle_Admin_s_ad0String_Admin_MyArticle_Text_WikiText_String_Template.class);
  ...
  { 
    ...
    page_admin_indexAdmin_saveContent10_ = (String)args[5];
  }

  public String getUniqueName()
  { 
    return "page_admin_indexAdmin_s_ad0String_WikiText_Text_MyArticle_Admin_s_ad0String_Admin_MyArticle_Text_WikiText_String";
  }
  ...
  { 
    return "template page_admin_indexAdmin_s_ad0String_WikiText_Text_MyArticle_Admin_s_ad0(page_admin_indexAdmin_saveContent23 : String, admin : Admin, u : Ref<MyArticle>, x : Ref<Text>, y : Ref<WikiText>, page_admin_indexAdmin_saveContent10 : String)";
  }
    ...
    { 
      ...
      case ACTION_PHASE:
        ...
        { 
          ...
          new page_admin_indexAdmin_saveContent0().run(threadLocalPageCached, getEnv(), getElementsContext(), (String)y_.get(), admin_, ident);
        }
        break;
