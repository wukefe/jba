...
public @SuppressWarnings("all") class login_ta2Bool_String_String_Template extends TemplateServlet 
{ 
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "login_ta2Bool_String_String" : keyOverwrite, login_ta2Bool_String_String_Template.class);
  ...
  { 
    return "login_ta2Bool_String_String";
  }
  ...
  { 
    return "template login_ta2(stayLoggedIn : Ref<Bool>, credPassword : Ref<String>, credUsername : Ref<String>)";
  }
  ...
  { 
    ...
    try
    { 
      handleTemplateCall(phase, inForLoop, forelementcounter, "tcall2", "inputBool", env.addExtraLocalTemplateArgumentsToArguments(new Object[]{stayLoggedIn_}, "inputBool"), new Environment(env).putWithcall("elements#inputBool", new utils.TemplateCall("elementsempty", null, null, null)), "inputBool", TemplateCall.EmptyAttrs);
    }
    catch(RuntimeException ex)
    { 
      printTemplateCallException(ex, "inputBool(stayLoggedIn) at unknown context");
    }
  }
}