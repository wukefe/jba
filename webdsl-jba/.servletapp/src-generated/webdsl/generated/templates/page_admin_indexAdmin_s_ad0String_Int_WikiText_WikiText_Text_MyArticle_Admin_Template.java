...
public @SuppressWarnings("all") class page_admin_indexAdmin_s_ad0String_Int_WikiText_WikiText_Text_MyArticle_Admin_Template extends TemplateServlet 
{ 
  ...
  { 
    page_admin_indexAdmin_s_ad0String_Int_WikiText_WikiText_Text_MyArticle_Admin_s_ad0String_Admin_MyArticle_Text_WikiText_WikiText_Int_String_Template.loadTemplateMap(staticEnv);
  }

  public static void loadRefArgClasses(Map<String, Class<?>> refargclasses)
  { 
    page_admin_indexAdmin_s_ad0String_Int_WikiText_WikiText_Text_MyArticle_Admin_s_ad0String_Admin_MyArticle_Text_WikiText_WikiText_Int_String_Template.loadRefArgClasses(refargclasses);
  }
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "page_admin_indexAdmin_s_ad0String_Int_WikiText_WikiText_Text_MyArticle_Admin" : keyOverwrite, page_admin_indexAdmin_s_ad0String_Int_WikiText_WikiText_Text_MyArticle_Admin_Template.class);
  ...
  { 
    return "page_admin_indexAdmin_s_ad0String_Int_WikiText_WikiText_Text_MyArticle_Admin";
  }
  ...
  { 
    return "template page_admin_indexAdmin_s_ad0(page_admin_indexAdmin_saveContent10 : String, id : Ref<Int>, ucontent : Ref<WikiText>, utitle : Ref<WikiText>, x : Ref<Text>, u : Ref<MyArticle>, admin : Admin)";
  }
  ...
  { 
    ...
    { 
      ...
      { 
        try
        { 
          handleTemplateCall(phase, inForLoop, forelementcounter, "tcall12", "wrapsubmitString", env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"page_admin_indexAdmin_saveContent2" + webdsl.generated.functions.getPage_.getPage_().getTemplateContext().getTemplateContextString()}, "wrapsubmitString"), new Environment(env).putWithcall("s", new utils.TemplateCall("page_admin_indexAdmin_s_ad0String_Int_WikiText_WikiText_Text_MyArticle_Admin_s_ad0String_Admin_MyArticle_Text_WikiText_WikiText_Int_String", getElementsContext(), new Object[]{admin_, u_, x_, utitle_, ucontent_, id_, page_admin_indexAdmin_saveContent10_}, attrs)), "wrapsubmitString", TemplateCall.EmptyAttrs);
        }
