...
public @SuppressWarnings("all") class page_admin_indexAdmin_s_ad0String_WikiText_WikiText_Text_MyArticle_Admin_Template extends TemplateServlet 
{ 
  ...
  { 
    page_admin_indexAdmin_s_ad0String_WikiText_WikiText_Text_MyArticle_Admin_s_ad0String_Admin_MyArticle_Text_WikiText_WikiText_String_Template.loadTemplateMap(staticEnv);
  }

  public static void loadRefArgClasses(Map<String, Class<?>> refargclasses)
  { 
    page_admin_indexAdmin_s_ad0String_WikiText_WikiText_Text_MyArticle_Admin_s_ad0String_Admin_MyArticle_Text_WikiText_WikiText_String_Template.loadRefArgClasses(refargclasses);
  }
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "page_admin_indexAdmin_s_ad0String_WikiText_WikiText_Text_MyArticle_Admin" : keyOverwrite, page_admin_indexAdmin_s_ad0String_WikiText_WikiText_Text_MyArticle_Admin_Template.class);
  ...
  { 
    return "page_admin_indexAdmin_s_ad0String_WikiText_WikiText_Text_MyArticle_Admin";
  }
  ...
  { 
    return "template page_admin_indexAdmin_s_ad0(page_admin_indexAdmin_saveContent10 : String, ucontent : Ref<WikiText>, utitle : Ref<WikiText>, x : Ref<Text>, u : Ref<MyArticle>, admin : Admin)";
  }
