...
public @SuppressWarnings("all") class Table_contentPage extends PageServlet 
{ 
  ...
  { 
    ...
    conversion();
    loadArguments();
    Object[] args = {admin_, len_};
    this.args = args;
  }

  protected void initTemplateClass()
  { 
    templateservlet = new table_content_Template();
  }
  ...
  { 
    ...
    combinedparams.append("{name:\"").append("len").append("\", value:\"").append(HTMLFilter.filterEcmaWithinHTML(len_.toString())).append("\"},");
  }
  ...
  { 
    ...
    combinedparams.append("len").append("=").append(utils.HTMLFilter.filter(utils.URLFilter.filter(len_.toString()))).append("&");
  }
  ...
  { 
    ...
    combinedparams.append("<input type=\"hidden\" name=\"").append("len").append("\" value=\"").append(utils.HTMLFilter.filter(len_.toString())).append("\" />");
  }
  ...
  { 
    ...
    if(parammap.get("len") != null)
    { 
      try
      { 
        len_ = Integer.valueOf(parammap.get("len"));
      }
