...
public @SuppressWarnings("all") class table_contentAdmin_Int_s_ad2String_MyArticle_Int_Admin_Template extends TemplateServlet 
{ 
  ...
  { 
    table_contentAdmin_Int_s_ad2String_MyArticle_Int_Admin_s_ad0String_Admin_Int_MyArticle_String_Template.loadTemplateMap(staticEnv);
  }

  public static void loadRefArgClasses(Map<String, Class<?>> refargclasses)
  { 
    table_contentAdmin_Int_s_ad2String_MyArticle_Int_Admin_s_ad0String_Admin_Int_MyArticle_String_Template.loadRefArgClasses(refargclasses);
  }
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "table_contentAdmin_Int_s_ad2String_MyArticle_Int_Admin" : keyOverwrite, table_contentAdmin_Int_s_ad2String_MyArticle_Int_Admin_Template.class);
  ...
  { 
    table_contentAdmin_Int_ia20_ = (String)args[0];
  ...
  { 
    return "table_contentAdmin_Int_s_ad2String_MyArticle_Int_Admin";
  }
  ...
  { 
    return "template table_contentAdmin_Int_s_ad2(table_contentAdmin_Int_ia20 : String, u : MyArticle, len : Int, admin : Admin)";
  }
