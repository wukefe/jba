...
public @SuppressWarnings("all") class table_contentAdmin_s_ad7String_MyArticle_Admin_Template extends TemplateServlet 
{ 
  ...
  { 
    table_contentAdmin_s_ad7String_MyArticle_Admin_s_ad0String_Admin_MyArticle_String_Template.loadTemplateMap(staticEnv);
  }

  public static void loadRefArgClasses(Map<String, Class<?>> refargclasses)
  { 
    table_contentAdmin_s_ad7String_MyArticle_Admin_s_ad0String_Admin_MyArticle_String_Template.loadRefArgClasses(refargclasses);
  }
  ...
  { 
    staticEnv.putTemplate(keyOverwrite == null ? "table_contentAdmin_s_ad7String_MyArticle_Admin" : keyOverwrite, table_contentAdmin_s_ad7String_MyArticle_Admin_Template.class);
  ...
  { 
    table_contentAdmin_ia70_ = (String)args[0];
  ...
  { 
    return "table_contentAdmin_s_ad7String_MyArticle_Admin";
  }
  ...
  { 
    return "template table_contentAdmin_s_ad7(table_contentAdmin_ia70 : String, u : MyArticle, admin : Admin)";
  }
  ...
  { 
    ...
    { 
      ...
      { 
        try
        { 
          handleTemplateCall(phase, inForLoop, forelementcounter, "tcall3", "wrapsubmitString", env.addExtraLocalTemplateArgumentsToArguments(new Object[]{"table_contentAdmin_ia7_" + webdsl.generated.functions.getPage_.getPage_().getTemplateContext().getTemplateContextString()}, "wrapsubmitString"), new Environment(env).putWithcall("s", new utils.TemplateCall("table_contentAdmin_s_ad7String_MyArticle_Admin_s_ad0String_Admin_MyArticle_String", getElementsContext(), new Object[]{admin_, u_, table_contentAdmin_ia70_}, attrs)), "wrapsubmitString", TemplateCall.EmptyAttrs);
        }
        catch(RuntimeException ex)
        { 
          printTemplateCallException(ex, "wrapsubmitString(\"table_contentAdmin_ia7\" +\ngetPage().getTemplateContext().getTemplateContextString()) at unknown context");
        }
      }
    }
  }
